    ...
    },
    {
      'cases': [
        ...
        },
        {
          ...
          >>> s0, s1 = hog.play(always(0), always(0), score0=11, score1=98, dice=always_three)
          >>> s0
          100
          >>> s1
          30
        ...
        },
        {
          ...
          >>> s0, s1 = hog.play(always(1), always(1), goal=20, dice=hog.make_test_dice(6, 4, 8, 1, 6, 6, 5))
          >>> s0
          21
          >>> s1
          15
        ...
        },
        {
          ...
          >>> s0, s1 = hog.play(always(1), always(4), score0=42, score1=96, dice=always_two)
          >>> s0
          104
          >>> s1
          44
